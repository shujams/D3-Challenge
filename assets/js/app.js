...
// xText will allow us to select the group without access code
...
// We add a second label group this time for axes left of the chart
...
function visualize(data){
    ...
    // Change classes and appearances of labels' text when clicked
    ...
    // First grab the mix and max values of x and y
    xMinMax()
    yMinMax();
